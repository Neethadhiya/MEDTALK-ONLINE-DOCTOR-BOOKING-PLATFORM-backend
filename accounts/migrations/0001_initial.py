# Generated by Django 4.2.5 on 2023-11-21 15:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='doctor_fees', to='accounts.doctor')),
            ],
        ),
        migrations.CreateModel(
            name='AdminFees',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('total_fees', models.FloatField(default=0)),
                ('admin', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='admin_fees', to='accounts.admin')),
            ],
        ),
        migrations.AddField(
